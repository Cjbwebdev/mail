...
function view_email(id){
  ...
  .then(email => {
    ...
    <ul class="list-group">
      <li class="list-group-item"><strong>From:</strong> ${email.sender}
      <li class="list-group-item"><strong>To:</strong> ${email.recipients}
      <li class="list-group-item"><strong>Subject:</strong> ${email.subject}
      <li class="list-group-item"><strong>Timestamp:</strong> ${email.timestamp}
      <li class="list-group-item"> ${email.body}
    </ul> 
    `
    // change to read
    if(!email.read){
    ...
    btn_arch.addEventListener('click', function() {
      ...
      .then(() => {
        const mailbox = email.archived ? 'archive' : 'inbox';
